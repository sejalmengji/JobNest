...
import linkdin_logo from './linkdin_logo.png'
...
export const manageJobsData = [
    { _id: 1, title: "Full Stack Developer", date: '10 April, 2025', location: "Bangalore", applicants: 20 },
    { _id: 2, title: "Frontend Developer", date: '14 April, 2025', location: "Chennai", applicants: 15 },
    { _id: 3, title: "Backend Developer", date: '25 April, 2025', location: "Mumbai", applicants: 2 },
    { _id: 4, title: "UI/UX Designer", date: '27 April, 2025', location: "Pune", applicants: 25 }
];
...
export const viewApplicationsPageData = [
    { _id: 1, name: "Hritik", jobTitle: "Full Stack Developer", location: "Bangalore", imgSrc: profile_img },
    { _id: 2, name: "Anna", jobTitle: "Data Analyst", location: "Delhi", imgSrc: profile_img },
    { _id: 3, name: "Sommya", jobTitle: "Backend Developer", location: "Mumbai", imgSrc: profile_img },
    { _id: 4, name: "Joy", jobTitle: "UI/UX Designer", location: "Noida", imgSrc: profile_img },
    { _id: 5, name: "Sam", jobTitle: "Cloud Architect", location: "Hyderabad", imgSrc: profile_img },
    { _id: 6, name: "Mady", jobTitle: "Frontend Developer", location: "Pune", imgSrc: profile_img },
    { _id: 7, name: "Suhana", jobTitle: "graphic designer", location: "Chennai", imgSrc: profile_img },
];
...
export const jobsData = [
    ...
    },
    {
        ...
        companyId: {
            "_id": "670e4d25ca9fda8f1bf359b9",
            "name": "Microsft",
            "email": "Microsft@gmail.com",
        },
        description: `
        <p>Join our innovative team as a Data Analyst, where you will analyze complex data sets to drive strategic decision-making. You will leverage your statistical and programming skills to uncover insights and develop predictive models, contributing to the overall success of our organization.</p>
        <h2><strong>Key Responsibilities</strong></h2>
        <ol>
